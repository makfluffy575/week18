const dataJson = `[
  {
    ...
    "url": "https://klichkapitomca.ru/images/13/a5/b2/13a5b2373d5e23489d9a4949ada5b927/547x397_0xac120002_8752067681540468870.jpg",
  ...
  },
  {
    ...
    "url": "https://admusinsk.ru/public/pic500f45a.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/7b/56/08/7b5608ec3df83d872fa1162fb9e32f28/547x397_0xac120002_1773711401540468871.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/37/39/74/373974effcc7ccd093d849e8fa062091/547x397_0xac120002_9548247751540468871.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/41/8f/05/418f050c767eeca8854b328914c7bccc/547x397_0xac120002_20106541761540468871.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/52/a3/e1/52a3e14a0c8f02715b763e7a20fe1c00/547x397_0xac120002_19311926741540468872.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/9a/28/e7/9a28e7b059594fc10387669ae4bd2f22/547x397_0xac120002_20162335021540468872.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/87/ed/c5/87edc525d8813c7b2899e04a4e562fe9/547x397_0xac120002_6444132261540468872.jpg",
  ...
  },
  {
    ...
    "url": "https://klichkapitomca.ru/images/e0/2b/55/e02b55b147eeaff9b3fe6bdbb36ff9ea/547x397_0xac120002_744074131540468872.jpg",
  ...
  },
  {
    ...
    "url": "https://adindex.ru/files2/news/2019_01/230499_5.jpg?ts=",
  ...
  heroCards.forEach(item => {
    ...
    item.addEventListener("click", function (evt) {
      if (evt.target.matches("button.btn")) {
        ...
        infoText.classList.add("fullTextInfo");

        for (let hero of heroes) {
          if (heroName.textContent == hero.name){
            let infoTextContent = hero.info;
    ...
    item.addEventListener("click", function (evt) {
      if (evt.target.tagName === "INPUT") {
        ...
        //установим value для чекбоксов
        const itemCheckboxCollection = item.querySelectorAll(".inputCheckbox");

        let value = 0;
        let inputArr = [];

        itemCheckboxCollection.forEach(input => {
          const inputId = input.id;
          inputArr.push(inputId);
          value = inputArr.indexOf(input.id) + 1;
